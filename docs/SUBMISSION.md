...
| 5-1 プレゼン資料 | mimamoritai-deck.pdf |
| 5-2 画面キャプチャ | 3点（`docs/captures/`） |
| 6-1 収録方法 | オンライン（Zoom） |
| **6-2 First Stage 収録予約** | **2026-08-26（水）19:00 JST / 30分枠** |
| 6-3 収録時の言語 | 日本語 |
...
- **8/26（水）19:00 の収録**に向けて、2分間のプレゼンを用意する。現在のデッキは18枚で2分に対して多いため、**課題→データ→ガードレール**の3点に絞った短縮版を作る（§7）
